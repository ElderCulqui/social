...
class CreateCommentsTest extends TestCase
{
    ...
    public function an_event_is_fired_when_a_comment_is_created()
    {
        ...
        Event::assertDispatched(CommentCreated::class, function($commentStatusEvent) {
            ...
            $this->assertEquals('socket-id', $commentStatusEvent->socket, 'The event '. get_class($commentStatusEvent) . ' must call the method "dontBroadcastToCurrentUser" in the constructor.');
            return true;
        });   
    }
}
